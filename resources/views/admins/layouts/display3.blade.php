                ...
                <div class="container">
                  ...
                  <ul class="navbar-nav">
                    <li class="nav-item ">
                        ...
                        <a href="{{ route('display.store')}}/ {{1}}"  class="nav-link"  data-toggle="tooltip" title="Sesi 1 : 09.00 -12.00 WIB"></i><span> Sesi 1</span></a>
                    </li>
                    <li class="nav-item">

                        <a href="{{ route('display.store')}}/ {{2}}" class="nav-link"  data-toggle="tooltip" title="Sesi 2 : 13.00 -15.00 WIB"></i><span>Sesi 2</span></a>
                        {{-- <a href="#" class="nav-link"></i><span>Sesi 2</span></a> --}}
                      </li>
                  </ul>
                </div>
              </nav>
